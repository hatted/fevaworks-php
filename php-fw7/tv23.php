...
abstract class television{
	abstract function getRepair();
	abstract function getVoltage();
	abstract function setVoltage($new_voltage);
	abstract function getName();
	abstract function turnOn();
	abstract function turnOff();
	abstract function volumeUp();
	abstract function volumeDown();
	abstract function getPlug();
	abstract function getColor();
	static function insurance(){
		echo "insurance cover $0<br>";
	}
}
